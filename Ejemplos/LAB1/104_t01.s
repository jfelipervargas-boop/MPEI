...
//=======================================================
stmfd sp!, {r4, r5}     // Save r4 and r5, used inside the subroutine
ldr r1, [sp, #8]        // Get str1 address from stack
ldr r2, [sp, #12]       // Get str2 address from stack
ldr r3, [sp, #16]       // Get max_buffer_size from stack
